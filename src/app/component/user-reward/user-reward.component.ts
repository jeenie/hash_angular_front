...
export class UserRewardComponent implements OnInit{
    ...
    sumUserTrading(list: UserProductVO[]) {
        ...
        for(let k=0; k <this.userProductList.length; k++) {
            if(this.selectedUserId == this.userProductList[k].USER_ID && this.userProductList[k].PRODUCT_STATE == 'G') {
